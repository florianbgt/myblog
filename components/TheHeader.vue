<template>
    <div>
        ...
        <b-navbar toggleable="md" fixed="top" type="dark" variant="secondary" style="height: 80px">
            <b-navbar-brand to="/">
                ...
                <strong>Blog.FlorianBgt.com</strong>
            </b-navbar-brand>
            ...
            <b-collapse id="nav-collapse" is-nav>           
                ...
                <b-navbar-nav class="ml-auto">
                    <b-nav-item href="https://florianbgt.com" target="_blank" class="active">
                        <big>About Me</big>
                    </b-nav-item>
                </b-navbar-nav>
            </b-collapse>
